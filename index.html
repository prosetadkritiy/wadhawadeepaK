...
fbq('init', '1271055094013553');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=1271055094013553&ev=PageView&noscript=1"
/></noscript>
<!-- End Meta Pixel Code -->
</head>
...
<body>
    <main>
        <div class="first">
            ...
            <a href="https://telegram.me/+0BLnb9M5L7o1OGFl" target="_blank">
        ...
        <div class="first">
            ...
            <p class="ppp" style="color: black;"><strong>100% Free:</strong> Absolutely No Hidden Fees or Charges—Only
                Pure Value!</p>
            <a href="https://telegram.dog/+NHeJN9FrTtUzMTQ1" target="_blank">
                <button class="join_btn">
                    <i class="fa-brands fa-telegram"></i> Join Telegram Channel
                </button>
            </a>
